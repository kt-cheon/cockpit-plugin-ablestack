...
$(document).ready(function(){
    ...
    $('#div-accordion-hci-shared-file-disk').hide();
...
$('#button-accordion-hci-shared-file-disk').on('click', function(){
    if ($('#button-accordion-hci-shared-file-disk').attr("aria-expanded") == "false") {
        ...
        $('#div-accordion-hci-shared-file-disk').fadeIn();
        ...
        $('#div-accordion-hci-shared-file-disk').fadeOut();
                            ...
                            <div class="pf-c-form__field-group-body" style="padding-top:0px;">
                                <div class="pf-c-form__group" style="padding:0px;">
                                    <div class="pf-c-form__group-label">
                                        <label class="pf-c-form__label" for="form-hci-shared-file-input-individual-credentials-ipmi-ip${i}">
                                            <span class="pf-c-form__label-text">IPMI IP</span>
                                            <span class="pf-c-form__label-required" aria-hidden="true">&#42;</span>
                                        </label>
                                    </div>
                                    <div class="pf-c-form__group-control">
                                        <input class="pf-c-form-control" style="width:70%" type="text" id="form-hci-shared-file-input-individual-credentials-ipmi-ip${i}" name="form-hci-shared-file-input-individual-credentials-ipmi-ip${i}" placeholder="xxx.xxx.xxx.xxx 형식으로 입력" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="pf-c-form__field-group-body" style="padding-top:0px;">
                                <div class="pf-c-form__group" style="padding:0px;">
                                    <div class="pf-c-form__group-label">
                                        <label class="pf-c-form__label" for="form-hci-shared-file-input-individual-credentials-ipmi-user${i}">
                                            <span class="pf-c-form__label-text">IPMI 아이디</span>
                                            <span class="pf-c-form__label-required" aria-hidden="true">&#42;</span>
                                        </label>
                                    </div>
                                    <div class="pf-c-form__group-control">
                                        <input class="pf-c-form-control" style="width:70%" type="text" id="form-hci-shared-file-input-individual-credentials-ipmi-user${i}" name="form-hci-shared-file-input-individual-credentials-ipmi-user${i}" placeholder="아이디를 입력하세요." required />
                                    </div>
                                </div>
                            </div>
                            <div class="pf-c-form__field-group-body" style="padding-top:0px;">
                                <div class="pf-c-form__group" style="padding:0px;">
                                    <div class="pf-c-form__group-label">
                                        <label class="pf-c-form__label" for="form-hci-shared-file-input-individual-credentials-ipmi-password${i}">
                                            <span class="pf-c-form__label-text">IPMI 비밀번호</span>
                                            <span class="pf-c-form__label-required" aria-hidden="true">&#42;</span>
                                        </label>
                                    </div>
                                    <div class="pf-c-form__group-control">
                                        <input class="pf-c-form-control" style="width:70%" type="password" autocomplete="off" id="form-hci-shared-file-input-individual-credentials-ipmi-password${i}" name="form-hci-shared-file-input-individual-credentials-ipmi-password1-check${i}" placeholder="비밀번호를 입력하세요." required />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            const common_HTML = `
                    <div class="pf-c-form__field-group">
                        ...
                        <div class="pf-c-form__field-group-body" style="padding-top:0px;">
                            <div class="pf-c-form__group" style="padding:0px;">
                                <div class="pf-c-form__group-label">
                                    <label class="pf-c-form__label" for="form-hci-shared-file-input-common-credentials-ipmi-ip${i}">
                                        <span class="pf-c-form__label-text">IPMI IP</span>
                                        <span class="pf-c-form__label-required" aria-hidden="true">&#42;</span>
                                    </label>
                                </div>
                                <div class="pf-c-form__group-control">
                                    <input class="pf-c-form-control" style="width:70%" type="text" id="form-hci-shared-file-input-common-credentials-ipmi-ip${i}" name="form-hci-shared-file-input-common-credentials-ipmi-ip${i}"  placeholder="xxx.xxx.xxx.xxx 형식으로 입력" required />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        const common_credentials_HTML= `
            <div class="pf-c-form__field-group">
                ...
                <div class="pf-c-form__field-group-body" style="padding-top:0px;">
                    <div class="pf-c-form__group" style="padding:0px;">
                        <div class="pf-c-form__group-label">
                            <label class="pf-c-form__label" for="form-hci-shared-file-input-common-credentials-ipmi-user">
                                <span class="pf-c-form__label-text">IPMI 아이디</span>
                                <span class="pf-c-form__label-required" aria-hidden="true">&#42;</span>
                            </label>
                        </div>
                        <div class="pf-c-form__group-control">
                            <input class="pf-c-form-control" style="width:70%" type="text" id="form-hci-shared-file-input-common-credentials-ipmi-user" name="form-hci-shared-file-input-common-credentials-ipmi-user" placeholder="아이디를 입력하세요." required />
                        </div>
                    </div>
                </div>
                <div class="pf-c-form__field-group-body" style="padding-top:0px;">
                    <div class="pf-c-form__group" style="padding:0px;">
                        <div class="pf-c-form__group-label">
                            <label class="pf-c-form__label" for="form-hci-shared-file-input-common-credentials-ipmi-password">
                                <span class="pf-c-form__label-text">IPMI 비밀번호</span>
                                <span class="pf-c-form__label-required" aria-hidden="true">&#42;</span>
                            </label>
                        </div>
                        <div class="pf-c-form__group-control">
                            <input class="pf-c-form-control" style="width:70%" type="password" autocomplete="off" id="form-hci-shared-file-input-common-credentials-ipmi-password" name="form-hci-shared-file-input-common-credentials-ipmi-password-check" placeholder="비밀번호를 입력하세요." required />
                        </div>
                    </div>
                </div>
            </div>
                ...
                if (pci_list[i].children != undefined) {
                    for (var j = 0; j < pci_list[i].children.length; j++) {
                            ...
                            if (!displayedName.has(disk_name)) {
                                ...
                                el += '<input class="pf-c-check__input" type="checkbox" id="form-hci-shared-file-checkbox-disk' + i + '" name="form-hci-shared-file-checkbox-disk" value="' + pci_list[i].path + '" ' + 'data-disk_id="' + pci_list[i].rbd_path + '" ' + check_disable + ' />';
                                // el += '<input class="pf-c-check__input" type="checkbox" id="form-hci-shared-file-checkbox-disk' + i + '" name="form-hci-shared-file-checkbox-disk" value="' + pci_list[i].path + '" />';
                                el += '<label class="pf-c-check__label" style="margin-top:5px" for="form-hci-shared-file-checkbox-disk' + i + '">' + pci_list[i].path + '\t' + pci_list[i].size + '\t' + pci_list[i].rbd_path + '\t' + partition_text + '</label>';
                                el += '</div>';
